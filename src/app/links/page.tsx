        ...
        {links.length === 0 ? (
          <div className="text-center py-12">
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md mx-auto">
              ...
              <p className="text-slate-600 mb-6">Start building your link collection by adding some links.</p>
              <Link
                href="/links-update"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-semibold text-slate-800 mb-4">All Links ({links.length})</h2>
              <div className="space-y-3">
                {links.map((link) => (
                  <div
                    key={link.id}
                    className={`group bg-white rounded-xl shadow-sm border-2 transition-all duration-200 hover:shadow-md cursor-pointer ${
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="ml-4 flex-shrink-0">
                          <div className={`w-3 h-3 rounded-full ${
                            selectedLink === link.id ? 'bg-blue-500' : 'bg-slate-300'
                          }`} />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-slate-50 border-b border-slate-200 px-4 py-3">
                    <div className="flex items-center justify-between">
                      <h3 className="font-medium text-slate-900">
                        {selectedLinkData ? 'Preview' : 'Select a link to preview'}
                      </h3>
                      {selectedLinkData && (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-slate-500 text-sm">
                            Click on a link to see its preview
                          </p>
                        </div>
                      </div>
                    )}
